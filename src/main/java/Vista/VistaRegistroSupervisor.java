 ...
 * @author USUARIO
 */
public class VistaRegistroSupervisor extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(VistaRegistroSupervisor.class.getName());

    /**
     * Creates new form VistaRegistroSupervisor
     */
    public VistaRegistroSupervisor() {
        initComponents();
    }
