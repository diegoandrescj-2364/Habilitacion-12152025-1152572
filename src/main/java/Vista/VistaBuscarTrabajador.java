 ...
 * @author Videoadicto
 */
public class VistaBuscarTrabajador extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(VistaBuscarTrabajador.class.getName());
